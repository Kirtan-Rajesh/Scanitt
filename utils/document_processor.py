    ...
    def processing_wrapper():
        try:
           ...
           if len(approx) != 4:
            ...
            # Memory optimization
            del gray, blurred, enhanced, edges, dilated_edges  # Release unused matrices
